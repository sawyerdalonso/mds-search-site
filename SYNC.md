...
- 2026-09-23 — [GPT 5.6 Sol] — Added first-party consent management for Apollo and Instantly: neither optional tracker is present or requested before affirmative consent; visitors can choose “Allow optional tracking” or “Necessary only”; choices persist for 180 days; a footer “Privacy choices” control supports later changes/withdrawal; and Global Privacy Control disables optional tracking. Added a compact on-brand, non-modal responsive consent panel and revised the privacy policy to document consent, storage and withdrawal. Browser validation passed at 390/768/1440 px plus accept, decline, withdrawal, GPC, all-route mobile overflow and contact-form usability checks. User requested consent management; production release is in progress. Files touched: all 10 HTML pages, `assets/js/main.js`, `assets/css/styles.css`, `privacy.html`, `SYNC.md`.
