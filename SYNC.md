...
- 2026-08-04 — [GPT 5.6 Sol] — Added Apollo website visitor tracking with app ID `6a56e0302cc63e001fd0caab` to the shared JavaScript loaded by all 10 pages. Updated the privacy policy to disclose Apollo visitor analytics/identification, relevant data use and Apollo's privacy policy, with an August 2026 revision date. JavaScript syntax and whitespace validation passed. User explicitly authorized commit, push and production deployment; release is in progress. Files touched: `assets/js/main.js`, `privacy.html`, `SYNC.md`.
